...
@NamedQueries({
    ...
    @NamedQuery(name = "InsumoTransaccion.findByHoraTransaccion", query = "SELECT i FROM InsumoTransaccion i WHERE i.insumoTransaccionPK.horaTransaccion = :horaTransaccion"),
...
public class InsumoTransaccion implements Serializable {
    ...
    public InsumoTransaccion(String insumocodInsumo, Date transaccionfechaTransaccion, Date horaTransaccion) {
        this.insumoTransaccionPK = new InsumoTransaccionPK(insumocodInsumo, transaccionfechaTransaccion, horaTransaccion);
    }
