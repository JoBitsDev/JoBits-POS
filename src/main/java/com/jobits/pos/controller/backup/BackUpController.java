 ...
 *
 */
public class BackUpController implements BackUpService {//TODO separar los paquetes SWING de esta capa
    ...
    //Constructores
    //
    public BackUpController(UbicacionConexionModel ubicacion, TipoBackUp tipoBackUp) {
    ...
    public BackUpController(UbicacionConexionModel connector) {
    ...
    public boolean EjecutarBackUpLineal(TipoBackUp tipo) {
        try {
            ...
            Logger.getLogger(BackUpController.class.getName()).log(Level.SEVERE, "Error en copia de seguridad: " + e.getMessage());
            return false;
        }
        return true;
    }
