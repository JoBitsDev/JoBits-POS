 ...
 *
 */
public class OldTransaccionListView extends OldAbstractListView<Transaccion> {

    public OldTransaccionListView(OldAbstractListController<Transaccion> controller, OldAbstractView parent, boolean modal) {
