...
public class Resumenes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextFieldFechaInit.setText(com.jobits.pos.recursos.R.DATE_FORMAT.format(dia.getFecha()));
    ...
    private void updateDialog(Venta dia, Cocina c) {
        jTextFieldFechaInit.setText(com.jobits.pos.recursos.R.DATE_FORMAT.format(dia.getFecha()));
        jTextFieldFechaFin.setText(com.jobits.pos.recursos.R.DATE_FORMAT.format(end));
