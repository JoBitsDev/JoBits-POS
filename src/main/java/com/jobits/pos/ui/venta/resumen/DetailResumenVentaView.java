...
import com.jobits.pos.ui.venta.resumen.presenter.DetailResumenVentaPresenter;
...
public class DetailResumenVentaView extends AbstractListResumenViewPanel<DayReviewWrapper, ProductovOrden> {
    ...
    public DetailResumenVentaView(DetailResumenVentaPresenter presenter) {
        super(presenter);
    ...
    @Override
    public DetailResumenVentaPresenter getPresenter() {
        return (DetailResumenVentaPresenter) super.getPresenter(); //To change body of generated methods, choose Tools | Templates.
    }
