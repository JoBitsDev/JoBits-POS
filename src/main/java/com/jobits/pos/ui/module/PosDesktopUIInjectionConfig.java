...
import com.jobits.pos.client.webconnection.gasto.GastoWCS;
...
class PosDesktopUIInjectionConfig extends AbstractModule {
    ...
    protected void configure() {
        ...
        //Gastos
        //
        bind(GastoOperacionService.class).to(GastoWCS.class).in(Scopes.SINGLETON);

        //
        //Image Manager //TODO: pifia aqui
        //
        bind(ImageManagerService.class).to(ImageManagerController.class).in(Scopes.SINGLETON);
