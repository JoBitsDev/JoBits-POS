 ...
 * @author Home
 */
public class DomicilioViewContainer extends javax.swing.JDialog {

    DomicilioView listView;
    Orden orden;
    DireccionEnvio ret;
     ...
     * @param orden
     */
    public DomicilioViewContainer(Orden orden) {
        super();
        this.orden = orden;
        setModal(true);
        init();
    ...
    public DireccionEnvio showView() {
    ...
    private void selectValue() {
        ret = listView.getPresenter().onAceptarClick();
        if (ret != null) {
            dispose();
        }
    }
    ...
    private void intitUI() {
        listView = new DomicilioView(new DomicilioViewPresenter(orden));
        listView.getjPanelBotones().setVisible(false);
